...
<section class="shopping-cart">
    ...
    <div  class="box">
        ...
        <div class="price">BDT<?php echo $fetch_cart['price']; ?>/-</div>
        ...
        <div class="sub-total"> sub-total : <span>BDT<?php echo $sub_total = ($fetch_cart['price'] * $fetch_cart['quantity']); ?>/-</span> </div>
    </div>
    <?php
    ...
    <div class="cart-total">
        <p>grand total : <span>BDT<?php echo $grand_total; ?>/-</span></p>
